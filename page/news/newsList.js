...
layui.use(['form','layer','laydate','table','laytpl','element','bodyTab'],function(){
    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            $("td[data-field = newsName]").on("click",function () {
                tools.openWindow({title:"客户详情",url:"template/add.html"});
            })
        }
    });
    ...
    table.on('tool(newsList)', function(obj){
        ...
        if(layEvent === 'edit'){ //编辑
            ...
            layer.alert('内容', {icon: 5})
            // layer.confirm('确定删除此文章？',{icon:1, title:'提示信息'},function(index){
            //     // $.get("删除文章接口",{
